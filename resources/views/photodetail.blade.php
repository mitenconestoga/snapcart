                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="product p-4">
                            ...
                            <div class="cart mt-4 align-items-center"> <button class="btn btn-danger text-uppercase mr-2 px-4">Add to cart</button> <button class="btn btn-warning text-uppercase mr-2 px-4">Buy Now</button> </div>
                        </div>
                    </div>
                </div>
            </div>
